...
async def approve(_, m : Message):
    ...
    try:
        ...
        await app.send_video(kk.id,img, "**🔥Join here for all new HD MOVIE'S\nhttps://t.me/+D7L-rX9lKA43MGRl\n\n🔥join here and request ur movies\nhttps://t.me/+wQpK7mlEc_JkNjVl\n\n🥵 sex porn video\nhttps://t.me/+Ce98xoyvoLcwYThl**".format(m.from_user.mention, m.chat.title))
        add_user(kk.id)
...
async def op(_, m :Message):
    try:
        ...
        if m.chat.type == enums.ChatType.PRIVATE:
            ...
            await m.reply_photo("https://te.legra.ph/file/9be2c3561a8943e063faa.jpg", caption="**{}\nI'm an auto approve [Admin Join Requests]({}) Bot.\nI can approve users in Groups/Channels.Add me to your Channel Or Group and promote me Admin with add members permission.\n\n__By : @jnaneshgowdru**".format(m.from_user.mention, "https://telegram.dog/jnaneshgowdru"), reply_markup=keyboard)
